...
while($r=mysqli_fetch_array($resv))
	
	{
		...
		$sqli="INSERT INTO reject(  cname,name,cid,address,domain,rdate,number,mail,salary,sslc,hsc,dc,ug,pg,dd,ac,eid,status)VALUES('".$cname."','".$name."','".$cid."','".$address."','".$domain."','".$rdate."','".$number."','".$mail."','".$salary."','".$sslc."','".$hsc."','".$dc."','".$ug."','".$pg."','".$dd."','".$ac."','".$eid."','".$cancel."')";
